...
var app = express();
//var http = require('http').createServer(app).listen(process.env.PORT||4567,function(){
...
var fs         = require("fs");
var key_file   = "HTTPS_Permissions/key.pem";
var cert_file  = "HTTPS_Permissions/cert.pem";
...
//var http = https.createServer(config,app).listen(6789);

//console.log('Application running on port 6789');
